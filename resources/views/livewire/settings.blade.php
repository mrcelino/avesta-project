      ...
      <div class="flex rounded-2xl shadow-md border-2">
        ...
        <div class="w-2/3 p-4 mt-10">
          ...
          <div class="mb-4 flex items-center">
            ...
            <div class="flex-grow flex items-center">
              <select wire:model="bank" class="w-full border-2 border-pink rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-pink-200">
          ...
          <button type="submit" wire:click="updateSettings" class="w-full bg-pink text-white font-semibold py-2 rounded-lg">Simpan</button>
        </div>
