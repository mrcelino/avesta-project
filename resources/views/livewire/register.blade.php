     ...
     <div class="w-7/12 pl-8">
      ...
      <form method="POST" action="{{ route('store') }}">
       ...
       <div class="grid grid-cols-2 gap-4 mb-4 ">
        <input class="border border-gray-300 rounded-2xl p-2 bg-cInput" placeholder="Nama Depan" type="text" name="nama_depan" id="nama_depan"/>
        @error('nama_depan')
            <span class="text-danger">{{ $message }}</span>
        @enderror
        <input class="border border-gray-300 rounded-2xl p-2 bg-cInput" placeholder="Nama Belakang" type="text" name="nama_belakang" id="nama_belakang"/>
        @error('nama_belakang')
            <span class="text-danger">{{ $message }}</span>
        @enderror
       </div>
       <div class="grid grid-cols-2 gap-4 mb-4 ">
        ...
        @error('email')
            <span class="text-danger">{{ $message }}</span>
        @enderror
        <input class="border border-gray-300 rounded-2xl p-2 w-full bg-cInput" placeholder="Nomor HP" type="text" name="no_telepon" wire:model="no_telepon" id="no_telepon"/>
        @error('no_telepon')
            <span class="text-danger">{{ $message }}</span>
        @enderror
       </div>
       ...
       <div class="mb-4">
        <input class="border border-gray-300 rounded-2xl p-2 w-full bg-cInput" placeholder="Konfirmasi Kata Sandi" type="password" name="password_confirmation" id="password_confirmation"/>
