<x-layouts.app>
    ...
    <header>
      <x-navmenu>
        <x-navlink href="{{ route('home') }}" useWireNavigate="true" class="text-heading pb-1 border-b-4 border-pink hidden md:block">Home</x-navlink>
        <x-navlink href="{{ route('product') }}" :useWireNavigate="true" class=" hover:text-heading group nav-link pb-1 hidden md:block">Produk</x-navlink>
        <x-navlink href="{{ route('about') }}" :useWireNavigate="true" class=" hover:text-heading group nav-link pb-1 hidden md:block">Tentang</x-navlink>
        <x-navlink href="{{ route('contact') }}" :useWireNavigate="true" class=" hover:text-heading group nav-link pb-1 hidden md:block">Hubungi</x-navlink>
        <div class="cursor-pointer border rounded-3xl p-2 border-heading hover:bg-heading group mr-2 hidden md:block">
        ...
        <div class="cursor-pointer rounded-3xl p-2 bg-heading text-white hover:bg-white group hover:border hover:border-heading hidden md:block">
