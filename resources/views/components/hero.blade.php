<section class="relative text-white overflow-hidden flex items-center justify-center bg-cover" style="background-image: url('/image/bghero.png'); height: 820px;">
  <div class="hidden md:block absolute top-0 left-0 w-56 ">
  ...
  <div class="hidden md:block absolute bottom-0 right-0 w-56">
  ...
  <div class="container mx-auto px-4 py-24 md:py-32 relative z-10">
      <div class="flex justify-center md:flex-row items-center">
          <div class="w-full mb-12 md:mb-0 text-center">
              <h1 class="text-4xl md:text-6xl font-bold mt-20 mb-6 leading-10">
                  Temukan Ayam Potong <br>dengan Harga Terbaik di Avesta
              </h1>
              <p class="text-lg md:text-xl mb-8 text-white leading-normal">
  ...
  <div class="hidden md:block absolute bottom-0 left-1/2 transform -translate-x-1/2">
