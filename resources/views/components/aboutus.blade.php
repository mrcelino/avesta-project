<div data-aos="fade-up" data-aos-duration="1000" class="w-full mx-auto mt-20 h-auto lg:h-[374px] flex flex-col lg:flex-row justify-center rounded-3xl overflow-hidden">
    
    <!-- Left Section -->
    <div class="bg-pink w-full lg:w-4/6 p-8 flex flex-col justify-center">
      <h1 class="text-white font-bold mb-10 text-5xl">Avesta</h1>
      <p class="text-white text-sm md:text-lg leading-relaxed font-semibold">
    ...
    <!-- Right Section -->
    <div class="bg-[#FF9FAD] w-full lg:w-2/6 flex justify-center items-center">
