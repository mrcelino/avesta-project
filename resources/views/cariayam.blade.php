                ...
                <div class="navbar-end">
                    ...
                    <x-dropdown>
                        <div class="border-pink border-2 rounded-xl mt-2 mb-2 p-2">
                            <p class="font-semibold text-lg text-pink">{{ $user->nama_depan }} {{ $user->nama_belakang }}</p>
                            <p class="text-base text-pink">{{ $user->email }}</p>
                        </div>
                        <x-slot:trigger>
                        ...
                        <x-menu-item class="hover:bg-pink hover:text-white active:bg-heading" href="{{ route('logout') }}" title="Logout" />
                    </x-dropdown>
                </div>
            </div>
        </nav>
