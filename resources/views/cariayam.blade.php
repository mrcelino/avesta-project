            ...
            <div class="navbar fixed mx-auto rounded-lg bg-pink shadow-md z-50">
                ...
                <div class="navbar-center w-[600px]">
                    <div class="bg-white flex px-4 py-3 rounded-full overflow-hidden w-full mx-auto">
                        <input wire:model="searchTerm" type="email" placeholder="Cari Ayam" class="w-full outline-none text-black text-sm" />
            ...
            <div class="container mx-auto p-4">
                <div class="flex justify-between items-center mb-4 mt-20">
                    <div class="flex space-x-4 bg-cInput w-full rounded-3xl p-2">
                        ...
                        <select wire:model="sortBy" name="sortBy" class="select select-bordered px-4 py-2 bg-white rounded-3xl shadow-md max-w-xs">
