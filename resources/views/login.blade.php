   ...
   <div class="w-1/2 pl-8">
    ...
    <form>
     <div class="grid grid-cols-2 gap-4 mb-4">
      <input class="border border-gray-300 rounded-xl p-2" placeholder="Nama Depan" type="text"/>
      <input class="border border-gray-300 rounded-xl p-2" placeholder="Nama Belakang" type="text"/>
     </div>
     <div class="mb-4">
